package org.doubao.user.service.config;
...
@Configuration
public class UserFeignErrorDecoderConfig {
	private static final Logger LOGGER = LoggerFactory.getLogger(UserFeignErrorDecoderConfig.class);
	@Bean
