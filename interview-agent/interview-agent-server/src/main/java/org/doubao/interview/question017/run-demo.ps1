# Semaphore 应用场景演示 - 运行脚本
Write-Host "╔════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║   Semaphore 面试题代码                ║" -ForegroundColor Cyan
Write-Host "╚════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""

$JAVA_CMD = "java"
$MAIN_CLASS = "org.doubao.interview.question017.demo.SemaphoreDemo"
...
Write-Host "[步骤 2/2] 运行 Semaphore 演示程序..." -ForegroundColor Yellow
Write-Host ""
