# ReadWriteLock 应用场景演示 - 运行脚本
Write-Host "╔════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║   ReadWriteLock 面试题代码            ║" -ForegroundColor Cyan
Write-Host "╚════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""

$JAVA_CMD = "java"
$MAIN_CLASS = "org.doubao.interview.question018.demo.ReadWriteLockDemo"
...
Write-Host "[步骤 2/2] 运行 ReadWriteLock 演示程序..." -ForegroundColor Yellow
Write-Host ""
